...
<%@ include file="../../mobile/comm/include.inc.jsp"%>
<%
...
<%@ include file="../../mobile/comm/basepath.jsp"%>
<%@include file="../../mobile/comm/link.inc.jsp" %>
...
<%@include file="../../mobile/comm/header.jsp" %>
<section id="tabOne">
...
<%@include file="../../mobile/comm/tabbar.jsp"%>
</section>
...
<%@include file="../../mobile/comm/footer.jsp" %> 

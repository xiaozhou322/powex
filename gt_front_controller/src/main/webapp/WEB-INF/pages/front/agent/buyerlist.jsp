...
<section class="uTrade mg clear">
            ...
            <div class="agentCon">
               <c:forEach items="${list}" var="v">
                <div class="table-item">
                    ...
                    <div class="tabs fl"><span class="buyBt sellBt" onclick="sellOut(${v.rate},${v.fid})"><spring:message code="market.sell" /></span></div>
                    <div class="clear"></div>
                 </div>                
                 </c:forEach>
            </div>
  ...
  <div class="warpForm">
        <div class="showBox showBox2">
            <h2 class="title">
                <spring:message code="market.sell" />USDT
            ...
            <div class="showCon sellShowCon">
                ...
                <p class="tr"><spring:message code="market.amount" />USDT <span><spring:message code="financial.accbal" />：${totalUsdt}</span></p>
...
<script type="text/javascript">
	...
	function doSell()
    {
    	...
    	var param = {'usdt_num':usdt_num,'cny_num':cny_num,'price':price,'agentorder_id':agentorder_id,'pay_pwd':pay_pwd,'free':free}

...
<section class="uTrade mg">
        ...
        <div class="TitBread">
             <a href="/agent/orderlist.html"><spring:message code="agent.orders" /></a> <i></i> <a href="javascript:;" class="colorBlue"><spring:message code="agent.orderdetails" /></a>
        </div>
        <div class="orderMain">
            <div class="tit clear">
                <p class="fl"><spring:message code="market.buy" />USDT&nbsp;&nbsp;<spring:message code="agent.orderid" />：<span>${fagentoperation.fid}</span></p>
                <p class="fr time">${fagentoperation.fstatus_s}<c:if test="${fagentoperation.fstatus == 1 }"><em id="minute_show">&nbsp;：30<spring:message code="agent.m" /></em><em id="second_show">&nbsp;00<spring:message code="agent.s" /></em> </c:if></p>
            </div>
            <div class="orderCon clear">
                <div class="orderDl fl">
                    <div class="orderPrice clear">
                        ...
                        <div class="fl priceInfo buyNum">
                         <spring:message code="agent.gprice" /><br />
                        <span class='colorBlue'>${fagentoperation.fprice}</span><em class="colorBlue">CNY/USDT</em>
                    </div>
                    </div>
                    ...
                    <div class="payHover">    
                        ...
                        <div class="orderAmount">
                            ...
                            <div class="fr payType">
                                <dl class="fl clear">
                                    <dt class='fl'><img src="${oss_url}/static/front2018/images/jfb.png" alt="" /></dt>
                                    <dd class='fl'>
	                    ...
	                    <div class="orderBtn clear">
	                         <c:if test="${is_agent == 1 }">      
		                        <c:if test="${fagentoperation.fstatus == 2 }"><span class="btn fl" onclick="confirmOrder()" onmouseover="$('.ts').fadeIn()">
		                         ...
		                         <c:if test="${fagentoperation.fstatus == 1 }"><span class="btn btn_2 fr" onclick="cancelOrder()" ><spring:message code="agent.canceldeal" /></span></c:if>
	                        </c:if>
	                         <c:if test="${is_agent == 0 && fagentoperation.fstatus == 1 }">
		                        ...
		                        <span class="btn btn_2 fr" onclick="cancelOrder()" ><spring:message code="agent.canceldeal" /></span>
	                         </c:if> 
	                    </div>
                   </c:if>
                </div>
...
<input type="hidden" id="times" value="1718248003" placeholder="">
...
<script type="text/javascript">
    ...
    function confirmOrder()
    {
    	...
    	jQuery.post('/agent/processorder.html', param, function (data) {

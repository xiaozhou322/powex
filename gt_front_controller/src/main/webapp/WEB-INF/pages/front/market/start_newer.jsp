	...
	<div id="chart_container" class="dark">
		...
		<!-- ToolBar -->
		<div id="chart_toolbar" style="background:#181b2a;">
	...
	<script type="text/javascript" src="${oss_url}/static/front2018/js/fullkline/fullKilne2018.js?t=<%=new java.util.Date().getTime() %>"></script>

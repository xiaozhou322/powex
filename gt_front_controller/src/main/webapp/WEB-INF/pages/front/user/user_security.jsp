    ...
    <div class="mg">
        <div class="l_finance clear">
            ...
            <div class="l_financeR fr tabBtn">
                <h2 class="financialCen"><spring:message code="newuser.security.settings" /></h2>
                <div class="aqMain">
                        <ul>
                            <li class="clear">
                                <div class="aq_tit fl">
            ...
            <!-- 修改手机号码 -->
                ...
                <a href="/user/security.html">
                    ...
                    <span class="attentionTit"><spring:message code="security.phonemsg" arguments="${loginName }" /></span>
                 </h2>      
            ...
            <div class="l_financeR fr tabBtn" style="display: none">
                <h2 class="financialCen"><a href="/user/security.html"><spring:message code="newuser.security.settings" /></a> 
                    ...
                    <span class="attentionTit"><spring:message code="security.emailmsg" arguments="${loginName }" /></span>
                </h2>                
                <div class="anquan">
                   <%--  <h3 class="ts cred">
            ...
            <!-- 修改登陆密码 -->
                ...
                <h2 class="financialCen"><a href="/user/security.html"><spring:message code="newuser.security.settings" /></a> 
                    ...
                    <span class="attentionTit"><spring:message code="security.dontforget" /></span>
                 </h2>                
                <div class="anquan">
                    <%-- <h3 class="ts cred">
                        <svg class="icon sfont18" aria-hidden="true">
            ...
            <!-- 交易密码 -->
              <div class="l_financeR fr tabBtn" style="display: none">
                ...
                <h2 class="financialCen"><a href="/user/security.html"><spring:message code="newuser.security.settings" /></a> 
                   ...
                   <span class="attentionTit"><spring:message code="security.whenwithdraw" /></span>
                 </h2>                
                <div class="anquan">
                   <%--  <h3 class="ts cred">
                        <svg class="icon sfont18" aria-hidden="true">
                        ...
                        <spring:message code="security.whenwithdraw" />
                    </h3> --%>
                    <div class="aqMain accountBdMain">
                        <div class="accoutType">
                            <div class="area accoutForm modifyPwd">
            ...
            <div class="l_financeR fr tabBtn" style="display: none;">
                ...
                <div class="anquan google">
                    ...
                    <c:if test="${isBindGoogle ==true}">
                        <div id="unbindgoogle" class="anquan">
                            <div class="area accoutForm modifyPwd">
                                <div class="aqMain accountBdMain">      
                                    <div class="tr_txt">

                      ...
                      <div class="lw-onlineAsk  lw-onlineAskCur">
                          <form action="" class="lw-askForm">
                              <label class="lw-label clear" for="">
                                  <span class="fl"style="width:143px; line-height:42px; margin-right:20px;"><spring:message code="security.quetype" /></span>
                              ...
                              <label class="lw-label clear" for="" style="margin-bottom:0px;">
                                  <span class="fl" style="width:143px; line-height:42px; margin-right:20px;"><spring:message code="security.prodes" /></span>
                                ...
                                <label for="" class="lw-label clear"> 
                                    <span class="fl"style="line-height:42px; margin-right:20px;"></span>
                                    <span id="errortips" class="text-danger fl"  style="margin-left:163px;"></span>
                                </label>
  <!--                                 <div class="">
                                      <span></span>
                                ...
                                <label class="lw-label clear" for="">
                                  <span class="fl" ></span>
                                  <input style="margin-left:163px;"  class="fl lw-askSub" type="button" value="<spring:message code="security.subques" />" id="submitQuestion" />
                              </label>

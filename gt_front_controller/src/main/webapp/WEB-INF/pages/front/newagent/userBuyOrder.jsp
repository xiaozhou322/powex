...
<link href="${oss_url}/static/front2018/css/webchat/chat.css?v=12" rel="stylesheet" type="text/css" />
...
<section class="orderCen">
<%-- <div class="uTradeH3"><spring:message code="agent.important.pay" /></div> --%>
        ...
        <div class="orderMain">
        	...
        	<div class="fragent">
        	<em id="minute_show">操作倒计时：&nbsp;--<spring:message code="agent.m" /></em>
        	<em id="second_show">&nbsp;--<spring:message code="agent.s" /></em> 
        	</div>
        	</c:if>
            ...
            <div class="orderidTit">
                ...
                <p class="fl">${forderuser.frealName} <spring:message code="market.buy" />${ad.fvirtualcointype.fShortName}</p>
            </div>
            <div class="orderCon clear">
                    <%-- <div class="orderPrice clear">
                 ...
                 <div class="fl">   
                    ...
                    <h3 style="font-size: 14px;color:#666;">
                    ...
                    <c:if test="${order.orderStatus > 101 && order.orderStatus != 106}">
	                    ...
	                    <c:forEach items="${paytypeList}" var="pay"> 
	                  	   <c:if test="${pay.payType == 1 }">
		                       <div class="noBoder clear">
		                        <div class="checkbox01">
								    <input type="radio" id="card_pay" name="paytype" value="${pay.id}"/>
								     <label for="card_pay" class="otc_pay">
								     	<dl class="fl">
	                        ...
	                        <c:if test="${pay.payType == 2 }"> 
		                        <div class="noBoder clear">
									<%-- <div class="radioType" style="display:inline-block;padding:20px 0px;">
		                        		<input type="radio" id="weixin_pay" name="paytype" value="${pay.id}" style="width:26px;height:26px;"/>
		                        	</div> --%>   
		                        	<div class="checkbox01">
									    <input type="radio" id="weixin_pay" name="paytype" value="${pay.id}"/>
									    <label  for="weixin_pay" class="otc_pay">
									    <dl class="fl payCode">
		                            ...
		                            <%-- <div class="fr payType">
		                                <dl class="fl clear">
		                                    <dt class='fl'><img src="${oss_url}/static/front2018/images/wx.png" alt="" /></dt>
		                                    <dd class='fl'>
		                                        <span><spring:message code="userinfo.nickname"/>${pay.realName}</span>
		                                        <span><spring:message code="userinfo.account"/>${pay.paymentAccount}</span>
		                                    </dd>
		                                ...
		                                <div class="clear"></div>
		                                <span class="usdt_code"><img src="${oss_url}/static/front2018/images/hCode.png" alt="" /></span>
		                                <i class="arr"></i>
		                                <div class="hoverPic" style="width: 220px;margin-top: 10px;left: 400px;z-index:99;">
		                                    <img src="${pay.qrCode}" alt="" />
		                                </div>
		                       ...
		                       <c:if test="${pay.payType == 3 }">                  
		                        <div class="noBoder clear">
	                        	<div class="checkbox01">
								    <input type="radio" id="alipay_pay" name="paytype" value="${pay.id}"/>
								    <label for="alipay_pay" class="otc_pay">
									    <dl class="fl payCode">
                    ...
                    <c:if test="${not empty order.payType}">
	                    ...
	                    <p class="txt"><span style="color: red; font-size: 16px"><spring:message code="agent.important.pay" /></span></p>--%>
	...
	<script type="text/javascript" src="${oss_url}/static/front2018/js/newagent/buyUserOrderDetail.js?v=201808211850"></script>
	<script type="text/javascript"

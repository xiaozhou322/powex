...
<%@include file="../comm/link.inc.jsp" %>
    ...
    .forgetPwd{text-align: right;padding-right: 0.2rem;}
    ...
    <div class="login">
        ...
        <div class="loginMain">
            <div class="login_inp">
               ...
               <img class="icon_user" src="${oss_url}/static/mobile2018/images/icon_user.png" alt="" />
            ...
            <div class="login_inp">
               <!-- <i class="iconfont icon-mima cblue2 fl"></i> -->
                <img class="icon_code" src="${oss_url}/static/mobile2018/images/icon_code.png" alt="" />
                <input class="txt" onfocus="this.type='password'" name="" id="login-password" placeholder="<spring:message code="security.logpas" />" autocomplete="off">
            </div>
            ...
            <div class="btns">
                ...
                <p><a href="/user/register.html" class="btn btn1"><spring:message code="nav.top.register" /></a></p>
            </div>
            <p class="forgetPwd">
                <a class="cblue" href="/validate/resetPhone.html">
                <spring:message code="nav.index.forpass" />
                <i style="vertical-align:-0.02rem; font-size:0.32rem;" class="iconfont icon-04wenhaofuzhi"></i>
                </a>
            </p>
        </div>
...
$(function(){
	$('#login-account').bind('input propertychange', function(){
		 if($('#login-account').val() != ''){
			 $(".icon_user").attr('src','${oss_url}/static/mobile2018/images/icon_user_sel.png');
		}else{
			$(".icon_user").attr('src','${oss_url}/static/mobile2018/images/icon_user.png');
		}
	});
	$("#login-password").bind('input propertychange', function(){
		 if($('#login-password').val() != ''){
			 $(".icon_code").attr('src','${oss_url}/static/mobile2018/images/icon_code_sel.png');
		}else{
			$(".icon_code").attr('src','${oss_url}/static/mobile2018/images/icon_code.png');
		}
	});
})
</script>

...
<%@include file="../comm/header.jsp" %>
  <div class="real">
    ...
    <div class="realCon">
         ...
         <div class="real_1">
           <h1 class="cblue2">KYC1&nbsp;<spring:message code="security.authentication" />
    ...
    <div class="kyc_02">
        ...
        <div class="real_btn to_up">
        	 <c:choose>
                ...
                <c:when test="${fuser.fhasRealValidate && fuser.fhasImgValidate && fuser.fpostImgValidate}">
                	<span class="s2 btn sub" style="opacity: 0.6;"><spring:message code="security.authenticated" /></span>
                </c:when>
                <c:otherwise>
	                <span class="btn sub s1" onclick="applyFaceIDValidate()" id="goApply">
	                <spring:message code="security.applyauthenticate" />
	                </span>
	                <a id="goValidate" href=""  class="s2 btn sub" >
	                <spring:message code="security.goauthenticate" />
	                </a>
                </c:otherwise>
             </c:choose>   
        </div>

...
<header class="header backHeader">  
    ...
    <h2 class="tit"><spring:message code="m.userloginlog.settinglog" /></h2>
</header>
<section>
     <div class="ticketsMain userloginLogMain">
        <div class="choiceMsg" style="padding:0.2rem 0.3rem;">
           <span class="fl style"><spring:message code="m.userloginlog.select" /></span>
            <span  style="margin:0.1rem 0 0 0.3rem;" class="fl selStyle" onclick="showtab('coinWarp');"><spring:message code="m.userloginlog.settinglog" /></span>
           <div class="clear"></div>
       </div>
       <select name="" id="select" class="fl select select8" style="display: none">
               <option value="1" ><spring:message code="m.userloginlog.loginlog" /></option>
               <option value="2" selected="selected"><spring:message code="m.userloginlog.settinglog" /></option>
        </select>  
         <div class="logMain">
             <table id="slidecontentbox">
                 <tr>
                     <th><spring:message code="security.loginlog.logtime" /></th>
                     <th><spring:message code="security.loginlog.seclog" /></th>
                 </tr>

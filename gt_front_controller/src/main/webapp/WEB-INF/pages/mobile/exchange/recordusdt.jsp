				...
				<c:if test="${type==0}">
                 ...
                 <c:if test="${fcapitaloperation.fstatus==2}">
                    <div class="stepsAll curSteps">
                         <img src="${oss_url}/static/mobile2018/images/ic01.png" alt="" />
                  ...
                  <c:if test="${fcapitaloperation.fstatus==3}">                       
                     <div class="stepsAll stepsSuccess">
                         <img src="${oss_url}/static/mobile2018/images/ic02.png" alt="" />
                   ...
                   <c:if test="${fcapitaloperation.fstatus==4}">
                     <div class="stepsAll stepsFailure">
                         <img src="${oss_url}/static/mobile2018/images/ic03.png" alt="" />
                 ...
                 <div class="step3Con textCenter">
                     ...
                     <c:if test="${fcapitaloperation.fstatus==4}"> 
	                     <div class="stepsAll stepsFailure">
	                         <img src="static/mobile2018/images/ic03.png" alt="" />
		...
		<table>
			<thead style="border-bottom: 1px solid #ececec;">
				<tr>
                    ...
                    <td><b><spring:message code="financial.usdtrecharge.orderno" /></b></td>
                    <td><b><spring:message code="financial.usdtrecharge.remarknum" /></b></td>
                    <td><b><spring:message code="financial.usdtrecharge.rechargestatus" /></b></td>
                    <td ></td>
				</tr>
			</thead>
		<c:forEach items="${fcapitaloperations}" var="v">
			<tbody>
				<tr >
					...
					<td class="colorRed">￥${v.famount }</td>
              ...
              <tr class="tr_spectial">
              		<td></td>
                	<td colspan="1">($<ex:DoubleCut value="${v.famount/6.5 }" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="4"/>)</td>
					<td colspan="2" class="td_01 "><fmt:formatDate value="${v.fcreateTime }" pattern="yyyy-MM-dd HH:mm"/></td>  
					<td colspan="1"><c:if test="${(v.fstatus==1 || v.fstatus==2)}">
								<span class="fr" style="color:#999;padding-right:0.11rem">
            ...
            <div class="noTxt textCenter mtop no-data-tips">
                <img src="${oss_url}/static/mobile2018/images/noMsg.png" alt="" />
                    ...
                    <%--  <div id="slidecontentbox_1">
                         ...
                         <table>
                               ...
                               <tr class="tr_spectial2">
                                   <td class="td_01"><spring:message code="financial.usdtrewithdrawal.amount" /></td>提币数量
                                   <td><spring:message code="financial.actarr" /></td>实际到账

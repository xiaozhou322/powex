...
<footer class="footer">
    <ul>
        ...
        <a href="/service/ourService.html?id=1" class="tabbar">
            ...
            <span><%-- <spring:message code="m.security.advisory" /> --%><spring:message code="m.security.infonews" /></span>
        </a>      
  ...
  $(document).ready(function(){
    	...
    	$('.tabbar').each(function(){
    		...
    		if($(this).index()>0)
    		{
	    		...
	    		{
	    			hasTab = 1;
	    		}else if(url.indexOf("/advertisement/buyList.html")!==-1){
	    			hasTab = 2;
	    		}else if(url.indexOf("/service/")!==-1){
	    			hasTab = 3;
	    		}else if(url.indexOf("/about/")!==-1 || url.indexOf("/user/")!==-1 || url.indexOf("/financial/")!==-1 || url.indexOf("/question/")!==-1 || url.indexOf("/trade/")!==-1 || url.indexOf("/account/")!==-1 || url.indexOf("/introl/")!==-1 || url.indexOf("/validate/")!==-1){
	    			hasTab = 4;
	    		}
    		}

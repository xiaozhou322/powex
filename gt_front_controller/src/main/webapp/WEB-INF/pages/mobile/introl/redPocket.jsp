...
<%@include file="../comm/header.jsp" %>
    ...
    <header class="tradeTop">
        ...
        <span><spring:message code="introl.income.redpocket" /></span>
    </header>

<div class="tg_detail">
    <ol class="clear">
        <li class="fl active"><spring:message code="introl.income.item" /></li>
        |
        <li class="fr active"><spring:message code="introl.income.date" /></li>
    </ol>
    <div class="tg_con">
        <div class="tgList">
            <ul>

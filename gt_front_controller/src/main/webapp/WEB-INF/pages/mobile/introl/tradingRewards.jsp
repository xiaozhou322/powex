...
<%@include file="../comm/header.jsp" %>
    ...
    <header class="tradeTop">
        ...
        <span><spring:message code="introl.income.incentives" /></span>
    </header>
   
<div class="tg_detail">
    <ol class="clear">
        <li class="fl"><spring:message code="introl.income.item" /></li>
        |
        <li class="fr"><spring:message code="introl.income.date" /></li>
    </ol>
    <div class="tg_con">
        <div class="tgList">
            <ul>

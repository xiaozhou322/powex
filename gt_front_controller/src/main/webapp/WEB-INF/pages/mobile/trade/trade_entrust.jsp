...
<header class="tradeTop">
	<a class="tradeTopa" href="/user/security.html">
	    <span class="back toback2"></span> 
	    <span class="tit">
	    	<spring:message code="entrust.title.${status eq 1?'deal':'entrust' }" />
	    </span>
	</a>
</header>
...
<script type="text/javascript" src="${oss_url}/static/mobile2018/js/trade/trade.js?v=20181126201750"></script>
</body>

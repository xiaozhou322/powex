            ...
            <div class="applyFor">
                ...
                <c:if test="${fagent.process == 0 }">
                    <div class="status1 active">
                        <img src="${oss_url}/static/mobile2018/css/agent/images/apply.png" alt="" />
                        <p>您的申请正在审核中</p>
                    </div>
                    </c:if>
                    <c:if test="${fagent.process == 2 }">                      
                    <div class="status1 status2 active">
                        <img src="${oss_url}/static/mobile2018/css/agent/images/fil.png" alt="" />
                        <p>您的申请失败了</p>
                    </div>
                    </c:if>
                    <c:if test="${fagent.process == 1 }">                     
                    <div class="status1 status3 active">
                        <img src="${oss_url}/static/mobile2018/css/agent/images/succ.png" alt="" />
                        <p>您的申请已通过</p>
                    </div>
                    </c:if>
                </div>

...
<link href="${oss_url}/static/mobile2018/css/phone.css?v=20190301163300100" rel="stylesheet" type="text/css" />
        ...
        <ul>
            <li class="active1">
                <a href="/agent/agentlist.html" class="tab_nav">
                    <img class="fl" src="${oss_url}/static/mobile2018/css/agent/images/buyicon.png" alt="" />
                    <span class="text">
                        <h2>买入USDT</h2>
            ...
            <li  class="active2">
                <a href="/agent/buyerlist.html" class="tab_nav">
                    <img class="fl" src="${oss_url}/static/mobile2018/css/agent/images/sellicon.png" alt="" />
                    <span class="text">
                        <h2>出售USDT</h2>
            ...
            <li  class="active3">
                <a href="/agent/orderlist.html" class="tab_nav">
                    <img class="fl" src="${oss_url}/static/mobile2018/css/agent/images/billcion.png" alt="" />
                    <span class="text">
                        <h2>订单记录</h2>
            ...
            <li  class="active4">
                <a href="/agent/payaccount.html" class="tab_nav">
                    <img class="fl" src="${oss_url}/static/mobile2018/css/agent/images/fileicon.png" alt="" />
                    <span class="text">
                        <h2>信息资料</h2>
                        <p>请完善您的信息</p>
                    </span>
                ...
                <div class="item_con">
                    <div class="tabs userFace fl">
                        ...
                        <div class="uName fl">
                            ...
                            <img src="${oss_url}/static/mobile2018/css/agent/images/v.png" alt="" />
                            </c:if>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="tabs group-payway fl">
                     <c:if test="${v.fagentpayaccount['openalipay'] == 1 }">
                        <i><img src="${oss_url}/static/mobile2018/css/agent/images/jfb.png" alt="" /></i>
                    </c:if>
                    <c:if test="${v.fagentpayaccount['openweixin'] == 1 }">
                        <i><img src="${oss_url}/static/mobile2018/css/agent/images/wx.png" alt="" /></i>
                    </c:if>
                    <c:if test="${v.fagentpayaccount['openbank'] == 1 }">
                        <i><img src="${oss_url}/static/mobile2018/css/agent/images/card.png" alt="" /></i>
                    </c:if>
                    </div>

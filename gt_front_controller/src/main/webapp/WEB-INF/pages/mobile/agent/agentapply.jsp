        ...
        <div class="agentApply">
            ...
            <div class="applyFor">
               ...
               <div class="applyType clear">
                    <dl class="fl">
                        <dt><img src="${oss_url}/static/mobile2018/css/agent/images/1.png"  /></dt>
                        <dd>专属展位</dd>
                    </dl>                    
                    <dl class="fl">
                        <dt><img src="${oss_url}/static/mobile2018/css/agent/images/2.png"  /></dt>
                        <dd>1&1服务</dd>
                    </dl>                    
                    <dl class="fl">
                        <dt><img src="${oss_url}/static/mobile2018/css/agent/images/3.png"  /></dt>
                        <dd>更低手续费</dd>
                    </dl>
                </div>
                <div class="careText">

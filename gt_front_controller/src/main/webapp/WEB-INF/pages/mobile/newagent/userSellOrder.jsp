...
<header class="tradeTop">  
    ...
    <span class="tit">${forderuser.frealName } 卖出${ad.fvirtualcointype.fShortName}</span>
</header>
        ...
        <div class="orderDetailMain">
            <div class="orderInfo">
               <%--  <div class="title clear">
                    <span class="fl">卖出${ad.fvirtualcointype.fShortName}</span>
                    <span class="fr cblue">
            	...
            	<div class="orderZf">
		            ...
		            <div class="payType clear">
		                <dl class="fl clear" style="width:100%;">
		                    <dt class="fl"><img src="${oss_url}/static/mobile2018/css/agent/images/card.png" width="50" alt="" style="margin-right:20px;"/></dt>
		                    <dd class="fl">
		                        <span>帐户名:&nbsp;&nbsp;${order.realName}</span>
		                        <span>所属银行：${order.bank}</span>
		                        <span>银行支行：${order.bankBranch}</span>
		                        <span>银行账号：${order.paymentAccount}</span>
		                    </dd>
		                </dl>
		            </div>
		            </c:if>
		            ...
		            <div class="payType clear">
		                <dl class="fl clear">
		                    <dt class="fl"><img src="${oss_url}/static/mobile2018/css/agent/images/wx.png" width="50" alt=""  style="margin-right:20px;"/></dt>
		                    <dd class="fl">
		                        <span>昵称：${order.realName}</span>
		                        <span>账号：${order.paymentAccount}</span>
		                    </dd>
		                </dl>
		                <div class="code fr">
		            ...
		            <div class="payType clear">
		                <dl class="fl clear">
		                    <dt class="fl"><img src="${oss_url}/static/mobile2018/css/agent/images/jfb.png" width="50" alt=""  style="margin-right:20px;"/></dt>
		                    <dd class="fl">
		                        <span>昵称：${order.realName}</span>
		                        <span>账号：${order.paymentAccount}</span>
		                    </dd>
            ...
            <div class="payNote order_payNote">
                ...
                <c:if test="${ad.user.ftelephone != null && ad.user.ftelephone !='' }"> 
                  	<c:if test="${fuser.fismerchant == false}">
                  		<p class="txt"><span id="telephone"><spring:message code="order.phone"/>${ad.user.ftelephone}</span></p>
                  	</c:if>
                </c:if>
	...
	<div class="panel panel-default chatPanel">
		...
		<div class="chatBody">
			...
			<div class="typeBody">
				...
				<button class="send-msg" type="button">发送</button>
			</div>
		</div>
	</div>
<!-- END即时通讯 -->
...
<script type="text/javascript" src="${oss_url}/static/mobile2018/js/newagent/sellUserOrderDetail.js?v=201808211860"></script>
<script type="text/javascript">

...
.uTrade{
    ...
    margin-top: 0.2rem;}
.buyBt{float:right;background: #F06338;}
.uTrade_l{
    display: block;
    overflow: hidden;
    clear: both;
...
<body>
				...
				<c:forEach var="v" varStatus="vs" items="${list}">
					...
					<ul class="fnickUl">
						...
						<div>
							...
							<p class="fr"> 
								<span class="buyBt" onclick="sellOut(${v.price },${v.id },'${v.fvirtualcointype.fShortName }')">
				...
				<%-- 	<!-- 承兑商 -->
					...
					<!-- 单价 -->
						...
						<div class="tabs rate fl">
							...
							${v.order_limit_min }~${v.order_limit_max }CNY
							</em>
						</div>
						<div class="tabs fl">
	...
	<%-- <div class="warpForm">
		<div class="showBox">
			<h2 class="title" style="margin-top: 50px;">
				<spring:message code="market.sell" />
				<span id="coin_type1"></span> 
				<span class='colorRed'>
				<spring:message	code="agent.showmsg" />
				</span>
			</h2>
			...
			<div class="showCon">
				...
				<span class="remind colorRed" style="display: none"><spring:message
						code="agent.cnyzero" /></span>
				<div class="btns">
					<input type="button" class="button active"
						value="<spring:message code="agent.confirm" />" onclick="doSell()" />
	...
	<div class="warpForm">
        ...
        <em class="close">×</em>
            ...
            <div class="showCon sellShowCon">
                <p class="rateBox"><spring:message code="agent.toprice" />（CNY/<em id="coin_type2"></em>）<span id="price">--</span></p>
	...
	<div class="coinWarp" id="coinWarp" onclick="hidetab(this.id);" style="z-index: 10000">
	    <div class="coinLitBox coinLitBox2">
          <ul>    
       		<c:forEach items="${fcoins}" var="t">
              <li> <a href="/advertisement/sellList.html?symbol=${t.fid }"><spring:message code="agent.navsell" />${t.fShortName}</a></li>
             </c:forEach>
          </ul>
	    </div>
	</div>

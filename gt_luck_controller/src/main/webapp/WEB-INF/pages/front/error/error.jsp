...
<%@include file="../comm/header.jsp" %>
 <section class="errorPage">
    <div class="mg">
        <img class="img" src="${oss_url}/static/front2018/images/error.png" alt="" />
<!--         <p class="p"><a class="returnBtn" href="${requestScope.constant['fulldomain'] }"><spring:message code="nav.top.home" /></a></p>  -->        

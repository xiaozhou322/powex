                    ...
                    <%--             <c:if test="${fuser.fpostRealValidate && !fuser.fhasRealValidate}">
                      ...
                      <%--      	<c:if test="${!fuser.fpostRealValidate || !fuser.fhasRealValidate}"> --%>
                                <div class="tr_txt">
                                     ...
                                     <c:otherwise>
                                      <input type="text" disabled="disabled" class="inpBox"  value="${fuser.frealName}" >
                                     </c:otherwise>
                                       </c:choose>
                                ...
                                <div class="tr_txt">
                                     ...
                                     <c:otherwise>
                                      <input type="text" class="inpBox" disabled="disabled" id="bindrealinfo-identityno" value="${fuser.fidentityNo_s }" placeholder="<spring:message code="new.idcard.number" />" autocomplete="off">
                                     </c:otherwise>
                                       </c:choose>
                                    ...
                                    <c:choose>
						                ...
						                <c:otherwise>
						                	<c:if test="${userFaceID != null && userFaceID.status == 103}">
						                		<span id="authfailed" style="display:  block;line-height: 39px;"><spring:message code="security.authenticatefailed" /></span>
						                	</c:if>

        ...
        <div class="loginMain regMain clear">
            <div class="loginL fl">
                <h2 class="clear">
                    ...
                    <a class="fr otherReg" href="/user/register.html"><spring:message code="security.regbyphone" /></a>
                </h2>
                <div class="txt_tr">
                    <label for="" class="label"  class=""><input id="register-email" class="tr_inp" type="text" placeholder="<spring:message code="nav.index.username.info" />" autocomplete="off" /></label>
                </div>
               <%--  <div class="txt_tr">
                    <label for=""  class="label" class=""><input id="register-imgcode" class="tr_inp" type="text" placeholder="<spring:message code="security.verifycode" />" autocomplete="off"/><img class="dyCode btn-imgcode" src="/servlet/ValidateImageServlet?r=<%=new java.util.Date().getTime() %>"></img></label>
                </div> --%>
                <div class="txt_tr">
                    <label for=""  class="label fl"><input id="register-email-code" class="tr_inp" type="text" placeholder="<spring:message code="security.everifycode" />" autocomplete="off" /><button class="getCode btn-sendemailcode register-msg" id="register-sendemail" data-msgtype="3" data-tipsid="register-errortips"><spring:message code="financial.send" /></button></label>
                </div>                
                <div class="txt_tr">
                     <label for=""><input class="tr_inp" id="register-password" type="password" placeholder="<spring:message code="security.setpassword" />" autocomplete="off"/></label>
                </div>                
                <div class="txt_tr">
                     <label for=""><input class="tr_inp" id="register-confirmpassword" type="password" placeholder="<spring:message code="security.repeatpassword" />" autocomplete="off" /></label>
                </div>
                <c:if test="${intro==null ||intro==''}">
                 <div class="txt_tr">
                     <label for=""><input class="tr_inp" id="invite_code" type="text" placeholder="<spring:message code="请输入邀请码" />" autocomplete="off" />(可选)</label>
                </div>
                </c:if>
                
                <div class="txt_tr" id="register-validate-email" style="margin-bottom: 20px"></div>
                ...
                <div class="tit">
                    <input id="agree" type="checkbox" checked="checked" /> <spring:message code="new.reg.agree" /><a href="/about/index.html?id=4" class="lightBlue">《<spring:message code="security.useragree" />》</a>
                </div>
                  <div class="txt_tr">
                    <p id="register-errortips" class="cred mgt15"></p>
                </div>
                <div class="txtBtn mgt20">
                    <span class="btn" id="register-submit"><spring:message code="nav.top.register"/></span>
           	...
           	<div class="fl" style="margin: 120px 0 0 28px;float: left;letter-spacing: 1px;line-height: 26px;">
                <p>

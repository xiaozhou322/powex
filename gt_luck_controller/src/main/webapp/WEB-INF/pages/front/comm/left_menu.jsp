                                ...
                                <li class="nav_item_list">
                                    ...
                                    <a href="/account/record.html">
                                        <svg class="icon icon_s" aria-hidden="true">
                                         ...
                                         </svg><spring:message code="newuser.financial.records" />
                                    </a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <li class="nav_item_list">
                                    <a href="/user/userloginlog.html">
                                        <svg class="icon icon_s" aria-hidden="true">
                                         ...
                                         </svg><spring:message code="security.loginlog" />
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul>
                                <li class="nav_item_list">
                                    <a href="/introl/mydivide.html?type=1">
                                        <svg class="icon icon_s sfont22" aria-hidden="true">
                                           <use xlink:href="#icon-leijishouyi"></use>
                                         </svg><spring:message code="introl.title" />
                                    </a>
                                </li>
                                <li class="nav_item_list">
                                    <a href="/introl/mydivide.html?type=2">
                                        <svg class="icon icon_s" aria-hidden="true" style="font-size: 18px;">
                                ...
                                <li class="nav_item_list">
                                    <a href="/introl/redPocket.html">
                                        <svg class="icon icon_s" aria-hidden="true">
                                         ...
                                         </svg><spring:message code="newuser.financial.Candy" />
                                    </a>
                                </li>
                                <li class="nav_item_list">
                                    <a href="/introl/tradingRewards.html">
                                        <svg class="icon icon_s" aria-hidden="true">
                                         ...
                                         </svg><spring:message code="newuser.financial.rewards" />
                                    </a>
                                </li>
                            </ul>
                        </li>

...
<header class="l-header usdt_header">
    <div class="clear">
         <h1 class="l-logo fl"><a href="/"><img src="${oss_url}/static/front2018/images/logo2.png" alt="" />&nbsp;&nbsp;<span style="color:#050505; font-size:18px;">GBCAX</span></a></h1>
         <nav class="l-nav fl">
             <ul class="fl">
<!--                  <li class="fl"><a href="/"><spring:message code="nav.top.home" /></a></a></li>
 -->                 <li class="fl"><a href="/agent/agentlist.html"><spring:message code="nav.top.home" /></a></a></li>
                 <li class="fl"><a href="/agent/orderlist.html"><spring:message code="agent.orderdetails" /></a></li>
                 <li class="fl"><a href="/agent/payaccount.html"><spring:message code="agent.user.center" /> </a></li>
                 <li class="fl"><a href="/agent/agentapply.html"><spring:message code="agent.merchant" /> </a></li>
         ...
         <div class="fr">
            <c:if test="${is_agent != 1 }">
             ...
             <c:if test="${is_agent == 1 }">
                <a href="/agent/puborder.html" class="fl release"><spring:message code="agent.advertise" /></a>
             </c:if>                 
             <div class="fl l-regForm">

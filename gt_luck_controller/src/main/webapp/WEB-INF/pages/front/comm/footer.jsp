...
<footer class="l-footer" style="padding: 0;position: fixed;bottom: 0;">
    <div class="footer_in mg clear" style="display: none;">
           ...
           <ul class="clear">
               ...
               <li>
                   ...
                   <span class="linksCodes">
                       <img src="${oss_url}/static/front2018/images/wxcode.png" width="100" alt="" />
                   </span>
               </li>
           </ul>
       </div>
    </div>
    <p class="CopyRight" style="margin-top:0;">CopyRight© 2013-2018 POWEX.PRO All Rights Reserved</p>
</footer>
...
<script type="text/javascript" src="${oss_url}/static/front2018/js/language/language_<spring:message code="language.title" />.js?v=2017102522162.js?v=20181126201750"></script>
<script type="text/javascript" src="${oss_url}/static/front2018/js/index/jquery.cookie.js?v=20171026105823.js?v=20181126201750"></script>

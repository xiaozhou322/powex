...
<div class="warp regWarp">  
    <div class="regMain">
        ...
        <div class="login_inp reg_ts clear">
            <input id="agree" type="checkbox" checked="checked" class="reg_checkbox" /><spring:message code="security.icertify" /><a style="user_xieyi cblue2" href="/about/index.html?id=4"><spring:message code="security.useragree" /></a>
            <a href="/user/register.html?phone=cn" class="fr cblue2 reg_email"><spring:message code="m.security.iphonereg" /></a>
        </div>
        <div class="btns">

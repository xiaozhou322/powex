...
<link href="${oss_url}/static/mobile2018/css/usdtTrade.css?v=3" rel="stylesheet" type="text/css" />
    ...
    <section class="usdtTrade">
        <div class="orderDetailMain">
            <div class="TitBread clear">
                订单管理<a href="javascript:;">订单详情</a>
            </div>
            <div class="orderInfo">
                <div class="title clear">
                    <span class="fl">买入USDT</span>
                    <span class="fr cblue times">${fagentoperation.fstatus_s}  <c:if test="${fagentoperation.fstatus == 1 }"><em id="minute_show">00分</em><em id="second_show">00秒</em></c:if></span>
                </div>
                <p class="order_num">订单号：<span>${fagentoperation.fid}</span></p>
                <ul class="clear list_tr">
                    ...
                    <li class="fl textRight">
                        ...
                        <em class="buyAmount">${fagentoperation.famount} USDT</em>
                    </li>
                </ul>
            </div>
            ...
            <div class="payType clear">
                <dl class="fl clear">
                    <dt class="fl"><img src="${oss_url}/static/mobile/css/agent/images/jfb.png" width="50" alt="" /></dt>
                    <dd class="fl">
            ...
            <div class="payType clear">
                <dl class="fl clear">
                    <dt class="fl"><img src="${oss_url}/static/mobile/css/agent/images/wx.png" width="50" alt="" /></dt>
                    <dd class="fl">
            ...
            <div class="payType clear">
                <dl class="fl clear" style="width:100%;">
                    <dt class="fl"><img src="${oss_url}/static/mobile/css/agent/images/card.png" width="50" alt="" /></dt>
                    <dd class="fl">
            ...
            <div class="payNote order_payNote">
                <h1>备注号<span>${fagentoperation.fremark}</span></h1>
                ...
                <c:if test="${fagentoperation.fstatus == 2 }">
                    <span class="btn fl" onclick="confirmOrder()" onmouseover="$('.ts').fadeIn()">
                        确认收款

        ...
        <ul>
            ...
            <li class="bank-item">           
                <div class="bank-item-top clear">                    
                    <i class="banklogo fl"><img src="${oss_url}/static/mobile/images/1.png" width="34" alt="" /></i>
                    <p>${v.fname }</p>
                    <p>${v.fbankNumber }</p>                  
                </div>
...
<%@include file="../comm/footer.jsp" %>	
	...
	<script type="text/javascript" src="${oss_url}/static/mobile/js/msg.js?v=1"></script>
	<script type="text/javascript" src="${oss_url}/static/mobile/js/account.assets.js?v=5"></script>

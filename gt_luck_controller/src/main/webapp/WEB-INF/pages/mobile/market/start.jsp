...
<!-- 					<li id="chart_period_1w_h" name="1w">
			...
			<!-- Open TabBar -->
			<div id="chart_show_indicator" class="chart_toolbar_button chart_str_indicator_cap" style="display:none;"></div>
			<!-- Open ToolPanel -->
			<div id="chart_show_tools" class="chart_toolbar_button chart_str_tools_cap" style="display:none;"></div>
			<!-- Theme -->
		...
		<!-- Canvas Group -->
		<div id="chart_canvasGroup" style="top:42px!important;zoom:0.75">
	...
	<script type="text/javascript" src="${oss_url}/static/mobile/js/comm/util.js?v=20171228101259.js?v=20181126201750"></script>
	<script type="text/javascript" src="${oss_url}/static/mobile/js/comm/comm.js?v=20171228101259.js?v=20181126201750"></script>
	<script type="text/javascript" src="${oss_url}/static/mobile/js/fullkline/jquery.mousewheel.js?v=20171228101259.js?v=20181126201750"></script>
	<script type="text/javascript" src="${oss_url}/static/mobile/js/fullkline/fullKilne.js?t=<%=new java.util.Date().getTime() %>"></script>
	...
	<script type="text/javascript">
		var locallang = "${pageContext.response.locale }".toLowerCase();
		_set_current_language(locallang.replace("_","-"));

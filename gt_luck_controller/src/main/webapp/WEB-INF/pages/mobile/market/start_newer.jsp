	...
	<title></title>
	<link rel="stylesheet" href="${oss_url}/static/mobile/css/fullkline/fullScreenKline.css?v=20181126201750" type="text/css"></link>
	 <script src="${oss_url}/static/mobile/js/h5kline/loading.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/util.js?v=13" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/absPainter.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/ajax.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/crossLines.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/axis-x.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/tip.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/linepainter.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/volumePainter.js" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/axis-y.js?v=1" type="text/javascript" charset="GBK"></script>
    <script src="${oss_url}/static/mobile/js/h5kline/chartEventHelper.kl.js?a2" type="text/javascript" charset="GBK"></script>
    <script type="text/javascript" src="${oss_url}/static/mobile/js/h5kline/controller.js" charset="GBK"></script>
	<script type="text/javascript" src="${oss_url}/static/front/js/comm/util.js?v=20171025221650.js?v=20181126201750"></script>
	...
	<%--  <script type="text/javascript" src="${oss_url}/static/mobile/js/h5kline/k-data.js?v=20181126201750"></script> --%>
	</canvas >
	...
	<script type="text/javascript" src="${oss_url}/static/mobile/js/jquery-1.11.2.min.js?v=20181126201750"></script>

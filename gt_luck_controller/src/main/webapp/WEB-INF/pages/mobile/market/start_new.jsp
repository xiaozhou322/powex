    ...
    <script src="${oss_url}/static/mobile/js/h5kline/util.js" type="text/javascript" charset="GBK"></script>
    ...
    <script src="${oss_url}/static/mobile/js/h5kline/axis-y.js" type="text/javascript" charset="GBK"></script>

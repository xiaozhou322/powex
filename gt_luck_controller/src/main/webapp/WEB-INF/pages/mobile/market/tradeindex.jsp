	    ...
	    <div class="tradeMain tradeCenter">
	        ...
	        <div class="trade_business">
	            <a href="javascript:;" class="fl" onclick="showBox('buybox')">
	                <dl>
	                    <dt class="fl"><img src="${oss_url}/static/mobile/images/buy.png" alt="" /></dt>
	                    <dd class="fl">
	            ...
	            <a href="javascript:;" class="fr" onclick="showBox('sellbox')">
	                <dl>
	                    <dt class="fl"><img src="${oss_url}/static/mobile/images/sell.png" alt="" /></dt>
	                    <dd class="fl">
...
<script type="text/javascript" src="${oss_url}/static/mobile/js/market/trademarket.js?t=<%=new java.util.Date().getTime() %>"></script>
<script type="text/javascript" src="${oss_url}/static/mobile/js/TouchSlide.1.1.source.js?v=3"></script>
</body>
</html>

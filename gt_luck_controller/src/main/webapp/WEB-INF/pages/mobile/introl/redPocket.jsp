...
<%@include file="../comm/header.jsp" %>
    ...
    <header class="tradeTop">
        ...
        <span><%-- <spring:message code="introl.income.detail" /> --%>糖果红包</span>
    </header>
    <div class="invitation">
        <dl class="clear">
            <dt class='fl'><img src="${oss_url}/static/mobile2018/images/tg.png" alt="" /> </dt>
            <dd class='fl'>
                <br/>
                <p><spring:message code="introl.affi.link" /> <span>${spreadLink }</span></p>
            </dd>
            <a class="lookGZ" href="javascript:;"><spring:message code="m.security.see" />&gt;&gt;</a>
        </dl>
        <span class='yq_btn'><spring:message code="m.security.yaoqing" /></span>
    </div>
</div>

<div class="tg_detail">
    <ol class="clear">
        <li class="fl active"><%-- <spring:message code="introl.affi.detail" /> --%>奖励金额</li>
        |
        <li class="fr active"><%-- <spring:message code="introl.income.detail" /> --%>收益日期</li>
    </ol>
    <div class="tg_con">
        <div class="tgList">
            <ul>

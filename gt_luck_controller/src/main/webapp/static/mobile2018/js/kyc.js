...
var security = {
    ...
    selectArea: function () {
        ...
        if (areacode=="86"){
        	...
        	$('#bindrealinfo-identitytypes').css('pointer-events',"none");
        	$('#bindrealinfo-identitytypes').removeClass("selStyle");
        	$('#backimgdiv').css('display','block');
        }else{
        	$('#bindrealinfo-identitytypes').css('pointer-events',"");
        	$('#bindrealinfo-identitytypes').removeClass("selStyle").addClass("selStyle");

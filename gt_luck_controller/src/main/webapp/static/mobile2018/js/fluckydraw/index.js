		...
		var clickfunc = function(data) {
			switch(data) {
				...
				case 8:
					...
					break;
				case 9:
					rotateFunc(9, 320, '恭喜您，获得四等奖！<a style="color: #ff6600;display: block;" href="/introl/redPocket.html">前往糖果红包查看</a>');
					break;
			}
		}
		$btn.click(function() {
		...
		jQuery.post(url,param,function(data) {
			...
			if (data.code == 1) {
				...
				// 没有币
				    ...
				    $(".WinningTit").html(data.msg);
					$(".Winning").attr("src", "/static/mobile2018/images/exchange/sad@2x.png");
					$(".comModule_title").text("没有币");
					$(".ngrealModule").show();
			...
			/*	$(".ngrealModule").show();
				...
				$(".powModulesBtn").html('前往充值');*/
				    ...
				    $(".WinningTit").html(data.msg);
					$(".Winning").attr("src", "/static/mobile2018/images/exchange/smail@2x.png");
					$(".comModule_title").text("未认证");
					$(".asdbtn").html('点击KYC1认证');

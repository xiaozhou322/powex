...
(function () {
    ...
    windowHelper.prototype = {
        ...
        toMoneyone: function (val) {
            var vaule = val.toString();
            // console.log(vaule.substring(0,7))
            // console.log(parseFloat(vaule.substring(0,6)));
            /*var pos = 2;
            return Math.round(val * Math.pow(10, pos)) / Math.pow(10, pos);*/
            return parseFloat(vaule.substring(0,7));
        },

var security = {
	...
	submitValidatePhoneForm : function(isUpdate, nvcData) {
	...
	submitBindPhone : function(isUpdate, nvcData) {
	...
	submitbindGoogleForm : function(nvcData) {
	...
	submitPwdForm : function(pwdType, istrade, nvcData) {
...
$(function() {
	...
	$("#unbindphone-Btn").on("click", function() {
		...
		security.submitValidatePhoneForm(1, nvcData);
	});
	...
	$("#bindphone-Btn").on("click", function() {
		var nvcData = getNVCVal();
		var callbackName = ('jsonp_' + Math.random()).replace('.', '');
		security.submitBindPhone(0, nvcData);
	});
	$("#bindgoogle-Btn").on("click", function() {
		var nvcData = getNVCVal();
		var callbackName = ('jsonp_' + Math.random()).replace('.', '');
		security.submitbindGoogleForm(nvcData);
	});
	...
	$("#unbindloginpass-Btn").on("click", function() {
		var nvcData = getNVCVal();
		var callbackName = ('jsonp_' + Math.random()).replace('.', '');
		security.submitPwdForm(0, true, nvcData);
	});
	$("#unbindtradepass-Btn").on("click", function() {
		var nvcData = getNVCVal();
		var callbackName = ('jsonp_' + Math.random()).replace('.', '');
		security.submitPwdForm(1, true, nvcData);
	});
	$("#bindtradepass-Btn").on("click", function() {
		var nvcData = getNVCVal();
		var callbackName = ('jsonp_' + Math.random()).replace('.', '');
		security.submitPwdForm(1, false, nvcData);
	});
});

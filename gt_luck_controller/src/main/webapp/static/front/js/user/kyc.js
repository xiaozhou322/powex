...
function uploadImg1() {
    if (checkFileType('pic1', 'img')) {
        ...
        $(".pic1show").css("background-image", "url(/static/front/images/user/loading.gif)");
        $('label[for="pic1"]').text("loading...");
...
function uploadImg2() {
    if (checkFileType('pic2', 'img')) {
        ...
        $(".pic2show").css("background-image", "url(/static/front/images/user/loading.gif)");
        $('label[for="pic2"]').text("loading...");
...
function uploadImg3() {
    if (checkFileType('pic3', 'img')) {
        ...
        $(".pic3show").css("background-image", "url(/static/front/images/user/loading.gif)");
        $('label[for="pic3"]').text("loading...");

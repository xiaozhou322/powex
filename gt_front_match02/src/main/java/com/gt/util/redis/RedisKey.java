...
public class RedisKey {
	...
	* @throws
	...
	public static String getBuyDepth(int id){
		return new StringBuilder(FRONT).append("buy:depth:").append(id).append(":").toString();
	}
	...
	* @throws
	...
	public static String getSellDepth(int id){
		return new StringBuilder(FRONT).append("sell:depth:").append(id).append(":").toString();
	}
	...
	* @throws
	 */
	public String getRates(int vid,boolean isbuy,int level){

...
<form id="pagerForm" method="post" action="/buluo718admin/questionList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/questionList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/viewQuestion.html">
				<li><a class="edit"
					href="/buluo718admin/goQuestionJSP.html?url=ssadmin//viewQuestion1&uid={sid_user}"

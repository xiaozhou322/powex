...
<form id="pagerForm" method="post" action="/buluo718admin/usdtCapitalInList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtCapitalInList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/usdtCapitalInAudit.html">
				<li><a class="edit"
					href="/buluo718admin/goCapitaloperationJSP.html?url=ssadmin/exchange/capitalInAudit&uid={sid_user}" target="dialog"
					height="600" width="750" title="确定要审核吗?"><span>审核</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalInCancel.html">
			<li><a class="edit"
				href="/buluo718admin/usdtCapitalInCancel.html?uid={sid_user}"
		...
		<thead>
			<tr>
				...
				<th width="40" orderField="famount"
					<c:if test='${param.orderField == "famount" }'> class="${param.orderDirection}"  </c:if>>人民币金额</th>
				<th width="40">USDT数量</th>
		...
		<tbody>
			<c:forEach items="${capitaloperationList}" var="capitaloperation"
				...
				<tr target="sid_user" rel="${capitaloperation.fid}">
					...
					<td><fmt:formatNumber value="${capitaloperation.famount/6.5}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="4"/></td>

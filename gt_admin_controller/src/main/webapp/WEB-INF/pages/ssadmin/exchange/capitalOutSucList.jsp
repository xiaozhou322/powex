...
<form id="pagerForm" method="post" action="/buluo718admin/usdtCapitalOutSucList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtCapitalOutSucList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
		...
		<tbody>
			<c:forEach items="${capitaloperationList}" var="capitaloperation"
				...
				<tr target="sid_user" rel="${capitaloperation.fid}">
					...
					<td>$<fmt:formatNumber value="${capitaloperation.famount}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="2"/></td>
					<td>￥<fmt:formatNumber value="${capitaloperation.famount*6.5}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="2"/></td>
					<td>$
					<fmt:formatNumber value="${capitaloperation.ffees}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="2"/></td>
	...
	<div class="panelBar">
		<div class="pages">
			<span>总共: ${totalCount}条，提现总额：${totalAmount*6.5}CNY，手续费收入：${totalFee*6.5}CNY</span>
		</div>

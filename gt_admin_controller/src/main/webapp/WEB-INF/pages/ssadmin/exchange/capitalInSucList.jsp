...
<form id="pagerForm" method="post" action="/buluo718admin/usdtCapitalInSucList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtCapitalInSucList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<div class="pages">
			<span>总共: ${totalCount}条，充值总额：${totalAmount}CNY</span>
		</div>

...
<form id="pagerForm" method="post" action="/buluo718admin/usdtCapitalOutList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtCapitalOutList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit1.html">
				<li><a class="edit"
					href="/buluo718admin/goCapitaloperationJSP.html?url=ssadmin/exchange/capitalOutAudit&uid={sid_user}&type=1" target="dialog"
					height="600" width="750" title="确定要审核吗?"><span>审核</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit2.html">
				<li><a class="edit"
					href="/buluo718admin/usdtCapitalOutAudit.html?uid={sid_user}&type=2"
					target="ajaxTodo" title="确定要锁定吗?"><span>锁定</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit3.html">
				<li><a class="edit"
					href="/buluo718admin/usdtCapitalOutAudit.html?uid={sid_user}&type=3"
					target="ajaxTodo" title="确定要取消锁定吗?"><span>取消锁定</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit4.html">
				<li><a class="edit"
					href="/buluo718admin/usdtCapitalOutAudit.html?uid={sid_user}&type=4"
					target="ajaxTodo" title="确定要取消提现吗?"><span>取消提现</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit5.html">
			<li><a title="确实要锁定这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="/buluo718admin/usdtCapitalOutAuditAll.html"
				class="edit"><span>全部锁定</span> </a>
			</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit6.html">
			<li><a class="edit"
				href="/buluo718admin/usdtViewUserWallet.html?cid={sid_user}" height="320"
				width="800" target="dialog"><span>查看会员资金情况</span> </a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit7.html">	
			<li><a class="icon" href="/buluo718admin/usdtCapitalOutExport.html"
				target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span>
			</a></li>	
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/usdtCapitalOutAudit8.html">
				<li><a class="edit"
					href="/buluo718admin/usdtCapitalOutAuditTeshu.html?uid={sid_user}"
					target="ajaxTodo" title="确定审核特殊账户吗?"><span>特殊账户审核</span> </a>
				</li>
			</shiro:hasPermission>
		</ul>
	</div>
	<table class="table" width="120%" layoutH="138">
		...
		<tbody>
			<c:forEach items="${capitaloperationList}" var="capitaloperation"
				...
				<c:if test="${capitaloperation.fuser.fscore.flevel==6}">style="color:#f00"</c:if>
				>
					...
					<td>${capitaloperation.fuser.frealName}
					<c:if test="${capitaloperation.fuser.fscore.flevel==6}">[特殊]</c:if>
					<c:if test="${capitaloperation.fuser.fistiger}">[操盘]</c:if>
					</td>
					...
					<td><fmt:formatNumber value="${capitaloperation.famount*6.5}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="2"/></td>

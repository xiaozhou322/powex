...
<form id="pagerForm" method="post"
	action="/buluo718admin/usdtWithdrawFeesList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtWithdrawFeesList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/usdtUpdateWithdrawFees.html">
				<li><a class="edit"
					href="/buluo718admin/goWithdrawFeesJSP.html?url=ssadmin/exchange/updateWithdrawFees&uid={sid_user}"

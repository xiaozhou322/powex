...
<form id="pagerForm" method="post"
	action="/buluo718admin/usdtCapitaloperationList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/usdtCapitaloperationList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<shiro:hasPermission name="buluo718admin/usdtCapitaloperationExport.html">
			<li><a class="icon" href="/buluo718admin/usdtCapitaloperationExport.html"

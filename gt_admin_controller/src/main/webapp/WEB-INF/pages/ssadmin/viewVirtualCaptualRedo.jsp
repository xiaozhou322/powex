...
<h2 class="contentTitle">审核虚拟币提现<font color="red">(只审核记录，不调用钱包)</font></h2>


<div class="pageContent">

	<form method="post" action="/buluo718admin/virtualCapitalOutRedoAudit.html"
...
<!-- 			<dl>
			...
			<c:if test="${needadmin==false }">
				...
				<dt>钱包密码：</dt>
					<dd>
						<input type="password" name="password" size="50" value="" class="required" />
					</dd>
				</dl>
				<dl>
				<dt>审核码：</dt>

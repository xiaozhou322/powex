...
<form id="pagerForm" method="post"
	action="/buluo718admin/virtualCapitalOutSucList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/virtualCapitalOutSucList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationJSP.html?url=ssadmin//updateVcTradeNumber&uid={sid_user}"
					height="200" width="800" target="dialog" rel="updateVcTradeNumber"><span>增加交易ID</span>
				</a></li>
			<li><a class="edit"
					href="/buluo718admin/virtualSucOp.html?uid={sid_user}"
					target="ajaxTodo" title="确定要重新拔币(未拔币)吗?"><span>重新拔币(未拔币)</span> </a>
				</li>
				<li>
				<a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/viewVirtualCaptualRedo"
					height="510" width="800" target="dialog"
					rel="viewVirtualCapitaloperation" title="确定要审核吗?"><span>重新转币审核</span>
				</a>
				</li>
		</ul>
	</div>
		...
		<thead>
			<tr>
				<th width="20" orderField="fid"
					<c:if test='${param.orderField == "fid" }'> class="${param.orderDirection}"  </c:if>>提现ID</th>

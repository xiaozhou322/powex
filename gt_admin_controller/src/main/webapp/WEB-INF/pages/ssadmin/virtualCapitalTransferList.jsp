...
<form id="pagerForm" method="post"
	action="/buluo718admin/virtualCapitalTransferList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/virtualCapitalTransferList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/viewVirtualCaptual.html">
				<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/viewVirtualCaptualTransfer"
					height="360" width="800" target="dialog"
					rel="viewVirtualCapitaloperation" title="确定要审核吗?"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/viewVirtualCaptual.html?type=1">
				<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/viewVirtualCaptualInfo"
					height="480" width="800" target="dialog"
					rel="viewVirtualCapitaloperation" title="确定要锁定吗?"><span>锁定</span>
				</a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/viewVirtualCaptual.html?type=2">
				<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationChangeStatus.html?uid={sid_user}&type=2"
					height="320" width="800" target="ajaxTodo"
					rel="viewVirtualCapitaloperation" title="确定要取消锁定吗?"><span>取消锁定</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/viewVirtualCaptual.html?type=3">
				<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationChangeStatus.html?uid={sid_user}&type=3"
					height="320" width="800" target="ajaxTodo"
					rel="viewVirtualCapitaloperation" title="确定要取消提现吗?"><span>取消转账</span>
				</a>
				</li>
				<li><a class="icon" href="/buluo718admin/vcOutExport.html"

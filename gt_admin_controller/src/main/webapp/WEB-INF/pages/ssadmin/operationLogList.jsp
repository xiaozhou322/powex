...
<form id="pagerForm" method="post"
	action="/buluo718admin/operationLogList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/operationLogList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/addOperationLog.html">
				<li><a class="add"
					href="/buluo718admin/goOperationLogJSP.html?url=ssadmin//addOperationLog"
					height="280" width="800" target="dialog" rel="addOperationLog"><span>新增</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/deleteOperationLog.html">
				<li><a class="delete"
					href="/buluo718admin/deleteOperationLog.html?uid={sid_user}"
					target="ajaxTodo" title="确定要删除吗?"><span>删除</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/auditOperationLog.html">
				<li><a class="edit"
					href="/buluo718admin/goOperationLogJSP.html?url=ssadmin/operationAuditLog&uid={sid_user}"

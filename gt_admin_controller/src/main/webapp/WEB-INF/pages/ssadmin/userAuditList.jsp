...
<form id="pagerForm" method="post" action="/buluo718admin/userAuditList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/userAuditList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/auditUser1.html">
				<li><a class="edit"
					href="/buluo718admin/goUserJSP.html?uid={sid_user}&url=ssadmin//auditUser"
					target="dialog" rel=auditUser height="400" width="800"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/auditUser2.html">	
			<li><a title="确实要审核这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="/buluo718admin/auditUserALL.html?type=1"
				class="edit"><span>全部审核通过</span> </a>
			</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/auditUser3.html">
			<li><a title="确实要审核这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="/buluo718admin/auditUserALL.html?type=2"

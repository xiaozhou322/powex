...
<h2 class="contentTitle">
	充值订单<font color="red">${capitaloperation.fid}</font>确认审核
</h2>


<div class="pageContent">

	<form method="post" action="/buluo718admin/capitalInAudit.html"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				<dt>金额：</dt>
				<dd style="color:#ff3300;font-weight:bold;font-size:18px;"><fmt:formatNumber value="${capitaloperation.famount}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="4"/></dd>
			</dl>
			<dl>
				<dt>手续费：</dt>

...
<form id="pagerForm" method="post"
	action="/buluo718admin/walletToExcBfscList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/walletToExcBfscList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		...
		<shiro:hasPermission name="buluo718admin/walletToExcBfscList.html">
			<li><a class="icon" href="/buluo718admin/drawAccountsStatisticsExport.html?shortName=BFSC&type=1"
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<c:forEach items="${walletToExcBfscList}" var="walletToExchange" varStatus="num">

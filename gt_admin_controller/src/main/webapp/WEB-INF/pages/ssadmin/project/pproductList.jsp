...
<form id="pagerForm" method="post" action="/buluo718admin/pproductList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/pproductList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/pproductList.html">
				<li>
					<a class="add"
						href="/buluo718admin/goPproductJSP.html?url=ssadmin//project//addProduct"
						height="400" width="750" target="dialog" rel="addProduct"><span>新增</span>
					</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/pproductList.html">
				<li>
					<a class="add"
						href="/buluo718admin/goPproductJSP.html?url=ssadmin//project//addApproCoinLogs&pid={sid_product}"
						height="400" width="750" target="dialog" rel="addProduct"><span>拨付</span>
					</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/pproductList.html">
				<li><a class="edit"
					href="/buluo718admin/goPproductJSP.html?url=ssadmin//project//pproductAuditDetail&pid={sid_product}&type=2"
					target="dialog" rel="productDetail" height="600" width="800"><span>查看</span>
				</a>
				</li>
			</shiro:hasPermission>
		</ul>

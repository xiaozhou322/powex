...
<form id="pagerForm" method="post" action="/buluo718admin/pprofitSettleList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/pprofitSettleList.html" method="post">
		<div class="searchBar">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<c:forEach items="${pprofitlogsList}" var="pprofitlogs" varStatus="num">
				<tr target="sid_trademapping" rel="${pprofitlogs.id}">

...
<form id="pagerForm" method="post" action="/buluo718admin/pcointypeAuditList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/pcointypeAuditList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/auditUser1.html">
				<li><a class="edit"
					href="/buluo718admin/pcointypeDetail.html?pid={sid_cointype}&type=1"
					target="dialog" rel=auditUser height="700" width="800"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
		</ul>

...
<form id="pagerForm" method="post" action="/buluo718admin/pfeesAuditList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/pfeesAuditList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/auditUser1.html">
				<li><a class="edit"
					href="/buluo718admin/pfeesDetail.html?pid={sid_fees}&type=1"
					target="dialog" rel=auditUser height="300" width="800"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
		</ul>

...
<form id="pagerForm" method="post" action="/buluo718admin/ptrademappingAuditList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/ptrademappingAuditList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/auditUser1.html">
				<li><a class="edit"
					href="/buluo718admin/ptrademappingDetail.html?pid={sid_trademapping}&type=1"
					target="dialog" rel=auditUser height="600" width="800"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
		</ul>

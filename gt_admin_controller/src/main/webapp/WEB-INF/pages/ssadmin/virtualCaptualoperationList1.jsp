...
<form id="pagerForm" method="post"
	action="/buluo718admin/virtualCaptualoperationList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/virtualCaptualoperationList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<!-- <li><a class="edit"
				href="/buluo718admin/goVirtualCapitaloperationJSP.html?url=ssadmin//viewVirtualCaptualStatus&uid={sid_user}&type=ViewStatus"

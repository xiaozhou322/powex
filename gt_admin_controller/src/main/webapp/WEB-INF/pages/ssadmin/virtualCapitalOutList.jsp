...
<form id="pagerForm" method="post"
	action="/buluo718admin/virtualCapitalOutList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/virtualCapitalOutList.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/viewVirtualCaptual.html">
				<li><a class="edit"
					href="/buluo718admin/goVirtualCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/viewVirtualCaptual"
					height="510" width="800" target="dialog"
		...
		<thead>
			<tr>
				<th width="20"  orderField="fid"
					<c:if test='${param.orderField == "fid" }'> class="${param.orderDirection}"  </c:if>>提现UID</th>

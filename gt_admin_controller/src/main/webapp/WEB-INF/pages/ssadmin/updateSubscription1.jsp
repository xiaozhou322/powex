...
<div class="pageContent">
	...
	<form method="post" action="/buluo718admin/updateSubscription1.html"
				...
				<dd>
					<select
						...
						<c:forEach items="${coins}" var="type">
							<c:if test="${type.key == (subscription.fvirtualcointypeCost == null?0:subscription.fvirtualcointypeCost.fid)}">

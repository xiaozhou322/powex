...
<form id="pagerForm" method="post" action="/buluo718admin/activityList.html?ty=0">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/buluo718admin/activityList.html?ty=0" method="post">
		<div class="searchBar">
		...
		<ul class="toolBar">
			...
			<shiro:hasPermission name="buluo718admin/updateActivity.html">
				<li><a class="edit"
					...
					height="500" width="900" target="dialog" rel="updateActivity"><span>审核</span>
				</a></li>
			</shiro:hasPermission>
		</ul>
	</div>

...
<form id="pagerForm" method="post" action="/buluo718admin/goSecurityJSP.html">
...
<div class="pageHeader">
	<form onsubmit="return divSearch(this, 'jbsxBox2moduleList');"
		action="/buluo718admin/goSecurityJSP.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="buluo718admin/addSecurity.html">
				<li><a class="add"
					href="/buluo718admin/goSecurityJSP.html?url=ssadmin//addSecurity&status=add&treeId1=${treeId}"
					height="250" width="800" target="dialog" rel="addLink"><span>新增</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/deleteSecurity.html">
				<li><a class="delete"
					href="/buluo718admin/deleteSecurity.html?uid={sid_user}" target="ajaxTodo"
					title="确定要删除吗?"><span>删除</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="buluo718admin/updateSecurity.html">
				<li><a class="edit"
					href="/buluo718admin/goSecurityJSP.html?url=ssadmin//updateSecurity&status=update&treeId1=${treeId}&uid={sid_user}"

...
public class ApiConstant {
	...
	public static String getUnknownError(Exception e) {
		...
		jsonObject.accumulate(APP_API_Controller.ErrorCode, ErrorCodeEnum._CODE_10000.getCode());
		jsonObject.accumulate(APP_API_Controller.Value, ErrorCodeEnum._CODE_10000.getMsg());

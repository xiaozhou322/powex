...
import com.gt.controller.exception.ErrorCodeEnum;
	...
	public String appApi(
		...
		if(actionInteger / 100==2){
			...
			if(isLogin==false){
				...
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10001.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10001.getMsg()) ;
		...
		if(fapis.size() == 1 ){
			...
			if((fapi.isFistrade()==false)){
				jsonObject.accumulate(Result , false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10002.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10002.getMsg()) ;
				return jsonObject.toString() ;
			}
			
			if((fapi.isFiswithdraw()==false)){
				jsonObject.accumulate(Result , false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10003.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10003.getMsg()) ;
				return jsonObject.toString() ;
			}
			...
			if("*".equals(fapi.getFip()) == false && fapi.getFip().indexOf(ip)==-1){
				jsonObject.accumulate(Result , false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10004.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10004.getMsg()) ;
				return jsonObject.toString() ;
			}
			appApiIp = ip;
			fuser = fapi.getFuser() ;
			if(null == fuser.getFgrade() || fuser.getFgrade() == 0) {
				jsonObject.accumulate(Result , false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10005.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10005.getMsg()) ;
				return jsonObject.toString() ;
			}
			appApiUid = String.valueOf(fuser.getFid());
		}else{
			jsonObject.accumulate(Result , false) ;
			jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10006.getCode()) ;
			jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10006.getMsg()) ;
			return jsonObject.toString() ;
		}
		...
		for (Map.Entry<String, String[]> entry : params.entrySet()) {
			...
			if(values.length!=1){
				jsonObject.accumulate(Result , false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10007.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10007.getMsg()) ;
				return jsonObject.toString() ;
			}
		...
		if(md5.equals(sign) == false ){
			jsonObject.accumulate(Result , false) ;
			jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10008.getCode()) ;
			jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10008.getMsg()) ;
			return jsonObject.toString() ;
		}
		...
		case 0 :
			{
				jsonObject.accumulate(Result, false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_10009.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10009.getMsg()) ;
	...
	public String TradePassword(HttpServletRequest request) throws Exception {
		try{
			...
			if(fuser.getFtradePassword()==null){
				...
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20025.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20025.getMsg()) ;
				return jsonObject.toString() ;
			}else if(fuser.getFtradePassword().endsWith(Utils.MD5(passwd, fuser.getSalt()))){
				jsonObject.accumulate(Result, true) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_0.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_0.getMsg()) ;
				return jsonObject.toString() ;
			}else{
				jsonObject.accumulate(Result, true) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20025.getCode()) ;
...
//							rabbitTemplate.convertAndSend("entrust.sell.remove", symbolAndIdStr);
				...
				if(flag==true){
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_0.getCode()) ;//成功
					jsonObject.accumulate(Value, "取消成功") ;//成功
					return jsonObject.toString() ;
				}else{
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_1.getCode()) ;//失敗
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_1.getMsg()) ;
					return jsonObject.toString() ;
				}
			}else{
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_1.getCode()) ;//失敗
	...
	public String GetMarketDepth(HttpServletRequest request) throws Exception {
		...
		try{
			...
			if(ftrademapping==null || ftrademapping.getFstatus()==TrademappingStatusEnum.FOBBID){
				JSONObject jsonObject = new JSONObject() ;
				jsonObject.accumulate(Result, false) ;
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20037.getCode()) ;//市场不存在或被禁用
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20037.getMsg()) ;
				return jsonObject.toString() ;
			}
	...
	public String getCoinAddress(HttpServletRequest request) throws Exception {
		...
		try{
			...
			if(coin.isFisrecharge()){
				...
				if(fpool == null){
					jsonObject.accumulate(ErrorCode, -20035) ;
				...
				jsonObject.accumulate(ErrorCode, -20036) ;
	...
	public String UserRegister(HttpServletRequest request) throws Exception {
		try{
			...
			if(!isOpenReg.equals("1")){
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20001.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20001.getMsg()) ;
				return jsonObject.toString() ;
			}
			
			password = HtmlUtils.htmlEscape(password.trim());
			if(password == null || password.length() <6){
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20002.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20002.getMsg()) ;
				return jsonObject.toString() ;
			}
			//邮箱
			if(regType==1){
				...
				if(flag1){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20003.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20003.getMsg()) ;
					return jsonObject.toString() ;
				}
				
				if(!phone.matches(Constant.PhoneReg)){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20004.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20004.getMsg()) ;
					return jsonObject.toString() ;
				}
				
				boolean mobilValidate = validateMessageCode(getIpAddr(request),areaCode,phone, MessageTypeEnum.REG_CODE, phoneCode) ;
				if(!mobilValidate){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20005.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20005.getMsg()) ;
					return jsonObject.toString() ;
				}
				...
				if(flag){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20006.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20006.getMsg()) ;
					return jsonObject.toString() ;
				}
				
				boolean mailValidate = validateMailCode(getIpAddr(request), phone, SendMailTypeEnum.RegMail, ecode);
				if(!mailValidate){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20007.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20007.getMsg()) ;
					return jsonObject.toString() ;
				}
				
				if(!regName.matches(Constant.EmailReg)){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20008.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20008.getMsg()) ;
					return jsonObject.toString() ;
				}
			...
			if(intro==null){
				...
				if(isMustIntrol.equals("1")){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20009.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20009.getMsg()) ;
					return jsonObject.toString();
				}
			}
			...
			if(fuser1!=null){
				...
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_0.getCode());// 注册成功
				...
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_10000.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10000.getMsg()) ;
				return jsonObject.toString() ;
			}
	...
	public String UserLogin(HttpServletRequest request) throws Exception {
		try {
			...
			if(longLogin == -1){
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20010.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20010.getMsg()) ;
				return jsonObject.toString() ;
			}
			
			List<Fuser> fusers = this.frontUserService.findUserByProperty("floginName", email);
			if(fusers == null || fusers.size() != 1){
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20011.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20011.getMsg()) ;
				return jsonObject.toString() ;
			}
			...
			if(limitedCount>0){
				...
				if(fuser!=null){
					...
					if(!isCanlogin.equals("1")){
						...
						if(!isCanLogin){
							jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20012.getCode());//用户被禁用
							jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20012.getCode()) ;
							return jsonObject.toString() ;
						}
					}
					...
					if(fuser.getFstatus()==UserStatusEnum.NORMAL_VALUE){
						...
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_0.getCode());//登陆成功
				    ...
				    jsonObject.accumulate("inviteCode", fuser.getFuserNo());
						...
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20013.getCode());//用户被禁用
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20013.getMsg()) ;
						return jsonObject.toString() ;
					}
				}else{
					//错误的用户名或密码
					if(limitedCount==Constant.ErrorCountLimit){
						jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20014.getCode()) ;
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20014.getMsg()) ;
					}else{
						jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20014.getCode()) ;
				...
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20015.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20015.getMsg()) ;
				return jsonObject.toString() ;
			}
		} catch (Exception e) {
			e.printStackTrace() ;
		...
		try{
			...
			if(isNeedTradePassword(request)){
				if(tradePwd == null || tradePwd.trim().length() == 0){
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20026.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20026.getMsg()) ;
					return jsonObject.toString() ;
				}
			...
			Ftrademapping ftrademapping = this.ftradeMappingService.findFtrademapping2(symbol) ;
			if(ftrademapping==null  ||ftrademapping.getFstatus()==TrademappingStatusEnum.FOBBID){
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20037.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20037.getMsg()) ;
				return jsonObject.toString() ;
			}
			...
			if(Utils.openTrade(ftrademapping,Utils.getTimestamp())==false){
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20038.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20038.getMsg()) ;
				return jsonObject.toString() ;
			}
			...
			if(!fuser.getFpostRealValidate()){
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20019.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20019.getMsg()) ;
				return jsonObject.toString() ;
			}
			...
			if(limited == 0 ){
				...
				if(tradeAmount<minBuyCount){
					...
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20039.getCode()) ;
				...
				if(tradeAmount>maxBuyCount && !fuser.isFistiger()){
					DecimalFormat decimalFormat = new DecimalFormat("#,##0.00000");
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20040.getCode()) ;
				...
				{
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20041.getCode()) ;
				...
				if(total < minBuyAmount){
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20043.getCode()) ;
					jsonObject.accumulate(Value, "最小挂单金额："+coin1.getfSymbol()+minBuyAmount);
					return jsonObject.toString() ;
				}
				
				if(total > maxBuyAmount && !fuser.isFistiger()){
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20044.getCode()) ;
			...
			if(fwallet.getFtotal()<totalTradePrice){
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20047.getCode()) ;
...
//				e.printStackTrace();
	...
	public String SendMessageCode(HttpServletRequest request) throws Exception {
		try {
			...
			if(type<=MessageTypeEnum.BEGIN || type>=MessageTypeEnum.END){
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20016.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20016.getMsg()) ;
				return  jsonObject.toString() ; 
			}
			...
			if( (type==MessageTypeEnum.FIND_PASSWORD || type == MessageTypeEnum.REG_CODE  )){
				...
				jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20018.getCode()) ;
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20018.getMsg()) ;
				return  jsonObject.toString() ; 
			}			
			Fuser fuser = this.getAppFuser(this.curLoginToken);
			if (fuser != null && fuser.isFisTelephoneBind()) {
			...
			if(type==MessageTypeEnum.FIND_PASSWORD ){
				if (isPhoneExists == false ) {
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20020.getCode());
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20020.getMsg());
					return jsonObject.toString();
				}
			}
			...
			if (phone.matches(Constant.PhoneReg)) {
				if (type == MessageTypeEnum.BANGDING_MOBILE) {
					...
					if (isLogin&&fuser.isFisTelephoneBind() == false) {
						jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20021.getCode());
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20021.getMsg());
						return jsonObject.toString();
					}
				}
				if(isLogin){
	...
	public String SendMailCode(HttpServletRequest request) throws Exception {
		try {
			...
			if(type<=SendMailTypeEnum.BEGIN||type>=SendMailTypeEnum.END){
				jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_10010.getCode());
				jsonObject.accumulate(Value, ErrorCodeEnum._CODE_10010.getMsg());
				return jsonObject.toString() ;
			}
			...
			if(type == SendMailTypeEnum.FindPassword){
				if(flag == false ){
					jsonObject.accumulate(ErrorCode, ErrorCodeEnum._CODE_20017.getCode());
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20017.getMsg());
					return jsonObject.toString() ;
				}
			}
		...
		public String drawAccountsSubmit(HttpServletRequest request) throws Exception{
			try {
				...
				if(StringUtils.isBlank(drawaccountsCfg)) {
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20030.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20030.getMsg()) ;
					return jsonObject.toString() ;
				}
				...
				if(fuser.getFid()==drawaccountsUserId) {
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20031.getCode()) ;
					jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20031.getMsg()) ;
					return jsonObject.toString() ;
				}
				...
				if(1 == type) {           //钱包划转到系统 
					...
					if(null == fvirtualwalletFrom) {
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20032.getCode()) ;
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20032.getMsg()) ;
						return jsonObject.toString() ;
					}
					//余额不足
					if(fvirtualwalletFrom.getFtotal()<amount){
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20033.getCode()) ;
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20033.getMsg()) ;
						return jsonObject.toString() ;
					}
					...
					//余额不足
					if(fvirtualwalletFrom.getFtotal()<amount){
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20034.getCode()) ;
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20034.getMsg()) ;
						return jsonObject.toString() ;
					}
				...
				try{
					...
					jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_0.getCode()) ;
					jsonObject.accumulate(Value, "划账成功，请稍后查看你的账户信息") ;
			...
			try{
				...
				if(null != virtualaddressList && virtualaddressList.size() > 0) {
					...
					if(coin.isFisrecharge()){
						...
						if (coin.getParentCid()>0){
							...
							if(addr==null || addr.trim().equalsIgnoreCase("null") || addr.trim().equals("")){
								...
								if(fpool == null){
									...
									if(!ethcoin.isFisBts()) {
										jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20035.getCode()) ;
										jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20035.getMsg()) ;
										return jsonObject.toString() ;
									}else {
						...
						jsonObject.accumulate(ErrorCode , ErrorCodeEnum._CODE_20036.getCode()) ;
						jsonObject.accumulate(Value, ErrorCodeEnum._CODE_20036.getMsg()) ;
						return jsonObject.toString() ;
					}
				}
				jsonObject.accumulate(ErrorCode, 0) ;

					...
					try{
						...
						if(fperiods.size()>0){
							for (Fperiod fperiod : fperiods) {
								LOGGER.info(CLASS_NAME + " work,市场ID： "+ id+",添加frontOthersService.addFperiod开始");
								this.frontOthersService.addFperiod(fperiod);
								LOGGER.info(CLASS_NAME + " work,市场ID： "+ id+",添加frontOthersService.addFperiod结束");
								LOGGER.info(CLASS_NAME + " work,市场ID： "+ id+",添加klinePeriodData.addFperiod开始");
								this.klinePeriodData.addFperiod(id, 0, fperiod);
								LOGGER.info(CLASS_NAME + " work,市场ID： "+ id+",添加klinePeriodData.addFperiod结束");
							}
						}

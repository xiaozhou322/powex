package com.gt.controller.constant;

import java.util.HashMap;

import com.gt.controller.app.AppApiController;
...
public class ApiConstant {
	...
	static {
		...
		i=201 ;
		actionMap.put("GetConvertCoinList", i++);
		actionMap.put("GetConvertRatio", i++);
		actionMap.put("GetConvertCoinFee", i++);
	...
	public static String getUnknownError(Exception e) {
		...
		jsonObject.accumulate(AppApiController.CODE, -10001);
		jsonObject.accumulate(AppApiController.MESSAGE, "网络错误，请稍后重试");
